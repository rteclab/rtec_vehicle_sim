...
def generate_launch_description():
    ...
    xacro_file = os.path.join(get_package_share_directory('rtec_vehicle_sim'), 'models/', 'vehicle.xacro')
    assert os.path.exists(xacro_file), "The xacro doesnt exist in "+str(xacro_file)

    install_dir = get_package_prefix('rtec_vehicle_sim')
    #print(xacro_file)
    ...
    spawn_car =  Node(package="gazebo_ros", executable='spawn_entity.py', arguments=["-topic", "/robot_description", "-entity", "car"])
